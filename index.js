    ...
    blog.outerHTML = `<section class="container_blog" id="blog1">
                          <div  class="blog">
                            ...
                            <p class="blog-paragraph">
                                Desde mi temprana edad comprendí mi propósito, como así mismo mi final. Pero ¿cómo es que llegue a tal entendimiento?, pues desde que tengo memoria mis padres son cristianos, donde Dios creo: el mundo, a nosotros mismo, a los animales, etc … Pero eso no era el caso, fue entonces cuando cumplí la edad de 5 años, donde solo era un niño, mi padre se sentó conmigo y me contó sobre Dios, el infierno , de que cuando muramos nosotros nos iremos al cielo o al infierno, eso me aterraba no quería ir al infierno , las personas pecadores van ahí, así que por eso yo intente ser un buen chico, me porte bien con mis padres y hermanos intentando ser el mejor hijo posible, pero poco a poco algo crecio dentro de mí. Cuando cumplí los 8 años, faltando poco para mi cumpleaños me sentí en duda, en el cual me pregunte que si ¿Dios existe?, y si Dios no existió... puede que al final cuando morimos simplemente desaparecemos, yo por mi mismo empeze a buscar la verdad; leyendo, viendo videos por internet , etc. Pero solo encontraba puras teorías estúpidas, como que el ser humano viene del los primeros seres vivientes en el mar... parte de  la teoría de la evolución, pero si es asi porque no seguimos evolucionando. Si el mundo se creó del bigbang, entonces cual fue esa fuerza que impulso para que chocaran dos átomos y se formara el universo, solo eran teorías no comprobadas, pero bueno, eso solo trajo sentimientos de tristeza, amargura, frustración, etc... sentimiento que los guarde dentro de mi. Cuando cumplí la edad de los 13 años mi padre me llevo a lo que se le llama campaña, había mucha gente ahí , yo solo me limite a observar como el predicador enseñaba... Antes de culminar la predica, se dio las oraciones... presencie por primera ves los milagros, qaquello no ttenia explicación para la ciencia, pero yo sabía que esos milagros eran causados por Dios... pero no quería aceptarlo, dentro de mí solo creció odio, y pues eso no fue la unica ves, mi padre me llevaba a sus visitas en casa de personas enfermas y veía como el mediaba para que Dios les sanase y pos si, se sanaban. Empecé a dejarme llevar por el mundo y olvidar estos pensamientos.
                            </p>
  ...
  if(body.children.blog3){
    ...
    blog.outerHTML = `<section class="container_blog" id="blog3">
                          <div  class="blog">
                              ...
                              <h2 class="blog-subtittle"><span>Temores &</span> Tristesa</h2>
                              <p class="blog-paragraph">
                              Creciendo más, empecé a desear tener una relacion, no solo por querer tener un romance, sino que deseaba tener a alguien para que me diera su cariño, quería que aquella persona me abraze y me diga "todo está bien, no te preocupes, hiciste lo mejor que pudiste", solo desea esas palabras de cualquier persona, no importaba que sea hombre o mujer, solo deseaba eso "compadecimiento y empatía". Mis padres nunca lo hicieron, tampoco hable esto con ellos, pensaba que como son mi padre, algún día se iban a dar cuenta, pero no lo hicieron, caí muy bajo, pero algo surgió dentro de mí, empece a pensar que tal vez mi propósito es hacer feliz a la gente y vivir por su felicidad, lo implemente y lo hice muchas veces con varias personas... pero sabía que aunque me trajese alegría a mi vida, todo esto solo era temporal... ahi fue cuando cai muy bajo y nuevamente empecé a destrozarme poco a poco... yo estaba decidido a quitarme la vida en unos meses o tal vez semanas, pero fue algo como cuando te das cuenta de que te vale madres tu propia vida, antes de suicidarme quería experimentar lo que era tomar y fumar, quería probar un poco de todo... lo hice, pero me sabia a mierda. Cuando me decidí en hacerlo, me aleje de todos pero antes quise jugar juegos como última cosa por hacer, así fue como te conocí. Yo por alguna razón (aunque ya se la razón ahora) me interese por ti, te escuche y pues surgió algo que nunca pude sentir, no sabía que era, pero me alegrabas mis dias... no quería perderte a ti, porque si lo hiciese, sabía que nunca podría volver a experimentar este hermoso sentimiento... poco después me di cuenta de que te realemte te amaba, un sentimiento de amor verdadero, aunque no supiese como era tus rostro y cuerpo, me enamore de vos... sabes no me importaba si eras gordita o de poco atractiva, nada de eso pasó por mi mente, yo solo te quería por tu propia existencia, solo conocerte trajo a mí la mayor felicidad. Sabía que tener una relación a distancia era riesgosa, pero sabía si esas dos personas se aman de verdad, entonces si podían superar ese muro y como un escritor dijo: " La distancia no es un problema, el problema somos los humanos que no sabemos amar sin tocar, sin ver o sin escuchar, el amor se siente con el corazón y no con el cuerpo". Me enamoré completamente de ti.
                              </p>
                              <div class="blog-box_button">
  ...
  presentacionFinalexeET.outerHTML = `<section class="section_declaration"> 
                                      <div class="section_box-container_declaration">
                                          ...
                                          <div class="box_paragraph">
                                              ...
                                              </br> Te amo demasiado: mi polola, mi chikita, mi princesa, mi chula, mi kokoro, mi musa, mi wawi, mi colita, mi amorcito, mi tesoro, mi vida, mi osita, mi tesoro... mi pequeña chika♥.
                                              </p>
                                              <!-- <ion-icon name="heart"></ion-icon> -->
                                          </div>
  ...
  if(declarationCheck.checked){
    ...
    body.style.transform = "scale(0)"
        setTimeout(()=>{
          ...
          <div class="respuesta">
            <h2>
              Oshe amor, si quieres volver a leer nuevamente solo tienes que recargar la pagina. byeee mi chikis.
            </h2>
             </div>`
